            ...
            <div className="flex flex-col gap-6 md:w-11/12">
                ...
                <div className="flex flex-col gap-6">
                    <p>
                        ...
                        Test Automation background from Argentina, currently
                        based in Germany.
                    </p>
                    <p>
                        I began my programming journey in Java focused on
                        automating end-to-end workflows using diverse approaches
                        and tools to cover front-end, back-end, and mobile
                        products. This involved adapting to various system
                        architectures including messaging systems,
                    ...
                    <p>
                        ...
                        challenge solidified my career path and reinforced my
                        dedication to pursue this role.
                    </p>
                    <p>
